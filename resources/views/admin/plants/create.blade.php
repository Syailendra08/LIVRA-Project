        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select name="condition" id="condition"
                    ...
                    <option value="healthy" {{ old('condition') == 'healthy' ? 'selected' : '' }}>Healthy</option>
                    <option value="sick" {{ old('condition') == 'sick' ? 'selected' : '' }}>Sick</option>
                    <option value="dead" {{ old('condition') == 'dead' ? 'selected' : '' }}>Dead</option>
                </select>
                @error('condition')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="health_benefits" id="health_benefits"
                       ...
                       value="{{ old('health_benefits') }}" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="cultural_benefits" id="cultural_benefits"
                       ...
                       value="{{ old('cultural_benefits') }}" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="growing_media" id="growing_media"
                       ...
                       value="{{ old('growing_media') }}" required>
                @error('growing_media')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
